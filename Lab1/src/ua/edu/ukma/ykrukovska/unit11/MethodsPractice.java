...
/* Create 16 methods that solve different tasks.
...
public class MethodsPractice extends ConsoleProgram {
    ...
    // Creates a game where user has to calculate numbers
    ...
    // Makes a list of prices based on the weight
    ...
    // Computer guesses the number and player is trying to guess it
    ...
    // Method which makes player's guesses possible
    ...
    // Shows the result of function calculation
    ...
    // Shows the result of factorial calculation
    ...
    // method which finds the biggest number out of the insterned ones
    ...
    // calculates sum and mean of the inserted numbers
    ...
    // Generates random 10 numbers and calculates their mean
    ...
    // Calculated the factorial of inserted number
    ...
    // Powers number 2 to 10 possible powers
    ...
    // Counts sum of n amount of odd numbers
    ...
    // counts sum of n amount of numbers
    ...
    // Powers first 10 numbers to two
